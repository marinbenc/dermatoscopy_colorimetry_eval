...
A Bland--Altman analysis (Fig.~\ref{fig:ita_bland_altman}, placeholder) reveals that the color quantization method agrees 
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.9\columnwidth]{../figures/ita_diffs_vert.pdf}}
...
\begin{figure*}[htbp]
\centerline{\includegraphics[width=0.9\textwidth]{../figures/confusion_matrices.pdf}}
